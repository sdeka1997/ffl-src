    ...
    <div className="space-y-16">
      ...
      <section>
        <div className="mb-6">
          ...
          <p className="text-slate-400 mt-2">
            Comparing regular season win percentage to playoff win percentage.
          </p>
                    ...
                    if (active && payload && payload.length > 0 && payload[0].payload.name === activeBar) {
                      return (
                        <div className="bg-slate-950 border border-slate-800 p-3 rounded-lg shadow-2xl text-xs space-y-1">
                          ...
                          <p className="text-slate-300">Reg Season: {payload[0].payload.regularWinPct}%</p>
                          <p className="text-slate-300">Playoffs: {payload[0].payload.playoffWinPct}%</p>
                          <p className="pt-1 border-t border-slate-800 font-bold text-white">
                            Differential: {payload[0].payload.differential}%
                          </p>
                        </div>
                      );
                    }
